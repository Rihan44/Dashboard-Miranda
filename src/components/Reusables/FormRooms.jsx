...
export const FormRooms = ({data, title}) => {
                            ...
                            <FormBox>
                                <FormBoxInner>
                                    ...
                                    <div>
                                        ...
                                        <Select>
                                            <Option selected="true">{data ? data.room_type : 'Room type...'}</Option>
                                    ...
                                    <div>
                                        ...
                                        <Input type="text" placeholder={data ? data.room_number : '186...'} />
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        <Label>Offer</Label>
                                        <Select>
                                            <Option selected="true">{data && data.offer_price}</Option>
                                            <Option>Yes</Option>
                                            <Option>No</Option>
                                        </Select>
                                    </div>
                                    <div>
                                        ...
                                        <Input type="text" placeholder={data ? data.price :"296.50..."} />
                                    </div>
                                    <div>
                                        <Label>Discount</Label>
                                        <Input type="number" min="0" max="100" placeholder={data ? (data.price - (data.discount * data.price / 100)): "20%..."} />
                                    </div>                              
                                    <div>
